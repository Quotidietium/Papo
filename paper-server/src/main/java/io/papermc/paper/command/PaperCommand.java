...
import io.papermc.paper.command.subcommands.NetstatCommand; // Papo - netstat
...
public final class PaperCommand extends Command {
    ...
    private static final Map<String, PaperSubcommand> SUBCOMMANDS = Util.make(() -> {
        ...
        commands.put(Set.of("netstat"), new NetstatCommand()); // Papo - per-player/server wire bandwidth accounting
